...
public class DashboardPage extends BrowserUtil {
	...
	private static final By READY_FOR_DELIVERY_LINK_LOCATOR = By
			.xpath("//span[text()=' Ready for delivery ']//..//..//..");
	private static final By DOWNLOAD_DELIVERY_NOTE_LINK_LOCATOR = By
			.xpath("//span[text()=' Download Delivery Note ']//..//..//..");
